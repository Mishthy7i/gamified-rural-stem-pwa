...
const StudentDashboard: React.FC = () => {
      ...
      const fetchMatches = async () => {
        try {
          ...
          if (matches.length === 0 && mySchool) {
            matches = allClasses.filter(
              (c) => c.school?.toLowerCase().trim() === mySchool
            );
          }

          if (matches.length === 0) {
            matches = allClasses.filter(
              (c) => c.teachingClass === userData.classLevel
            );
          }
  ...
  const hasSchool =
    userData?.school &&
    userData.school !== "Skipped" &&
    userData.school.trim() !== "";
  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="dashboard-content animate-fade-in-up">
            ...
            <div className="header-subtitle">
              ...
              {hasSchool && (
                <>
                  ...
                  <span>
                    {t("dashboard.school")}: {userData?.school}
                  </span>
                </>
              )}
            </div>
        ...
        <div
          className={hasSchool ? "dash-grid-2" : ""}
          style={{
            maxWidth: hasSchool ? "100%" : "600px",
            margin: hasSchool ? "0" : "0 auto",
          }}
        >
          {hasSchool && (
              ...
              >
                ...
                <div className="premium-input-group">
                  ...
                  <button
                    ...
                    disabled={!manualCode || loadingCode}
                  >
                    <Search size={20} /> Join
                  </button>
                </div>
          ...
          >
            ...
            >
              Want to learn on your own without a classroom? Explore our
              missions and earn points!
            </p>
            <button
